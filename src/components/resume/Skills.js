    ...
    >
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          <p className="text-sm text-yellow-400 tracking-[4px] uppercase">
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[60%] h-full bg-gradient-to-r from-blue-600 via-pink-500 to-yellow-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[70%] h-full bg-gradient-to-r from-blue-600 via-pink-500 to-yellow-500 rounded-md relative"
              >
